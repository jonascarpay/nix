...
in
{
  ...
  users = {
    ...
    users.jmc = {
      ...
      openssh.authorizedKeys.keys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFimUlKSw3ba2gS1tj3cKVYI0UB167nbBgraHIE6lh+D woven-personal"
      ];
      # mkpasswd -m sha-512
  ...
  documentation = {
    ...
    man.cache.enable = true; # Needed for fish man page completions
    dev.enable = true;
  };
